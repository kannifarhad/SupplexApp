      ...
      <Box className="loginBlock">
        <Box className="loginForm">
          <Box className="title">
            ...
            <p>
              <Trans>
                Remember that login attempts are limited and your IP may be
                blocked due to incorrect attempts.
              </Trans>
            </p>
          </Box>
          ...
          <FormProvider {...formMethods}>
            ...
            <Box className={clsx(classes.inputItems, "form-group")}>
                    ...
                    <PasswordField
                      ...
                      helperText={
                        Boolean(fieldState.error) ? (
                          ...
                          <Trans>
                            You can see the password by clicking on the eye icon
                          </Trans>
                        )
                      }
                      {...fieldMethods}
              ...
              />
              <Link className={classes.forgerPassLink} to="/forgetpassword">
                {" "}
